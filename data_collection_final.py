...
count = len(oss.listdir("C:\Sign-Language\AtoZ\A"))
c_dir = 'A'
...
cv2.imwrite("C:\Sign-Language\model.h5",white)
...
while True:
    try:
        ...
        white = cv2.imread("C:\Sign-Language\white.jpg")
        ...
        if interrupt & 0xFF == ord('n'):
            ...
            if ord(c_dir)==ord('Z')+1:
                c_dir='A'
            flag = False
            count = len(oss.listdir("C:\Sign-Language\AtoZ" + (c_dir) + "\\"))
        ...
        if flag==True:
            ...
            if suv==180:
                flag=False
            if step%3==0:
                cv2.imwrite("C:\Sign-Language\AtoZ" + (c_dir) + "\\" + str(count) + ".jpg",
                            skeleton1)
