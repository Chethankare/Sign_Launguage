...
class Application:
    ...
    def __init__(self):
        ...
        self.T.config(text="ASL to Text Conversion and Speaking Interface", font=("Courier", 30, "bold"),fg="red")
        ...
        self.T1.config(text="Character :", font=("Courier", 30, "bold"),fg="green")
        ...
        self.T3.config(text="Sentence :", font=("Courier", 30, "bold"),fg="green")
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\white.jpg")
                # img_final=img_final1=img_final2=0
